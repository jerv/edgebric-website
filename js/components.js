  ...
  if (headerEl) {
    headerEl.outerHTML =
      '<nav id="nav">' +
        '<div class="wrap nav-inner">' +
          ...
          '<ul class="nav-links">' +
            ...
            '<li><a href="' + base + '/index.html#pricing" class="btn-sm">Download</a></li>' +
          '</ul>' +
      ...
      '<div class="nav-mobile" id="nav-mobile">' +
        ...
        '<a href="' + base + '/index.html#pricing" class="btn-sm" onclick="this.parentElement.classList.remove(\'open\')">Download</a>' +
      '</div>';
  }
